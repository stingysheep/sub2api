...
describe('CreateAccountModal OpenAI long-context billing', () => {
  ...
  it('submits OpenCode Zen default protocol rules with adaptive endpoints', async () => {
    ...
    await wrapper.get('[data-testid="create-account-api-key"]').setValue('sk-opencode-zen')
  ...
  it('submits OpenCode GO endpoints after switching account type', async () => {
    ...
    await wrapper.get('[data-testid="create-account-api-key"]').setValue('sk-opencode-go')
  ...
  it('submits adaptive MiniMax protocol endpoints', async () => {
    ...
    await wrapper.get('[data-testid="create-account-api-key"]').setValue('sk-minimax')
  ...
  it('antigravity upstream 创建默认携带上游倍率探测开关', async () => {
    ...
    await wrapper.get('[data-testid="create-account-api-key"]').setValue('sk-upstream')
    await wrapper.get('form#create-account-form').trigger('submit.prevent')
    await flushPromises()
