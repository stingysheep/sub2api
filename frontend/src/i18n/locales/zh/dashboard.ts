export default {
  ...
  affiliate: {
    title: '邀请返利',
    heroEyebrow: '分享链接 · 持续收益',
    heroTitle: '邀请好友，持续返利',
    heroDescription: '好友通过你的专属链接注册并产生可分配利润后，你将按展示比例获得返利额度。活跃好友越多，返利越多。',
    heroCopyLink: '复制专属链接',
    heroCopyCode: '复制邀请码',
    viewDetails: '查看推广收益',
    copyLink: '复制专属链接',
    ...
    rulesButton: '返利规则详情',
    startTitle: '开始推广',
    startDescription: '复制专属链接或邀请码，分享给你的朋友和社群。',
      rulesTitle: '返利规则详情',
      rulesFormulaTitle: '返利金额计算方式',
      rulesFormula: '返利只来自被邀请用户使用付费余额产生的正利润，免费额度和亏损请求不产生返利。',
      rulesFormulaCode: '返利 = max(付费消费 - 对应上游成本, 0) × 实际返利比例',
      rulesExampleTitle: '计算示例',
      rulesExample: '假设被邀请用户在某分组产生 100 元付费消费，对应上游实际成本为 80 元，则可分配利润为 20 元。若当前返利比例为 25%，本次预计返利为 5 元。',
      rulesExampleIncome: '被邀请用户付费消费',
      rulesExampleIncomeValue: '100 元',
      rulesExampleCost: '对应上游实际成本',
      rulesExampleCostValue: '80 元',
      rulesNote: '免费额度消费、上游成本高于付费消费的请求，以及负利润请求，均不会产生返利。',
    steps: {
      shareTitle: '分享链接', shareDescription: '发送给好友或社群',
      registerTitle: '好友注册', registerDescription: '通过专属链接完成注册',
    ...
    stats: {
      rebateRate: '我的返利比例',
      rebateRateHint: '页面展示比例；实际返利以平台结算规则为准',
      invitedUsers: '邀请人数',
    ...
    tips: {
      ...
      line2: '被邀请用户产生可分配利润后，页面展示返利比例为 {rate}。',
      line3: '返利额度可随时转入账户余额。',
