export default {
    ...
    users: {
      ...
      balanceSource: '余额来源',
      freeBalance: '免费体验额度',
      paidBalance: '付费余额（已消费/有收入）',
      balanceSourceHint: '免费额度不计入收入；付费余额消费会计入收入。',
      balanceConfirmTitle: '确认余额来源',
      balanceConfirmMessage: '本次增加 {amount}，将记为“{source}”。确认后将用于盈亏分析。',
      withdrawAmount: '退款金额',
      withdrawAll: '全部',
    ...
    groups: {
      ...
      accounts: {
        ...
        testPassed: '测试通过',
        testFailed: '测试失败',
        testCompleted: '已完成 {count} 个账号的测试',
        testSelectedGroups: '测试已选分组（{count}）',
        testingGroups: '正在测试分组...',
        testSelectedGroupsEmpty: '已选分组没有可测试的账号',
        testGroupsCompleted: '已完成已选分组中 {count} 个账号的测试',
        enabledSelected: '已启用 {count} 个账号',
        disabledSelected: '已停用 {count} 个账号',
        updated: '账号已更新',
        removed: '账号已移出分组',
        enabled: '账号已启用',
        disabled: '账号已停用',
