export default {
    accounts: {
      ...
      upstreamProfiles: {
        fieldTooLong: '分类名称或前缀过长（最多 100 字节），或 URL 超过 500 字节。',
        duplicateId: '分类编号冲突，请关闭编辑器后重新打开。',
        loading: '正在加载分类…',
        loadFailed: '分类加载失败，请重试；当前配置未被修改。',
        missingProfile: '待恢复分类 #{id}',
        inUse: '此分类仍有关联账号，请先调整账号归属。',
        stale: '分类已被其他窗口修改，请关闭编辑器后重新打开再保存。',
        title: '上游中转站分类',
        description: '按中转站集中维护账号命名和统一地址标准。',
        manage: '管理分类',
        select: '上游中转站分类',
        none: '不使用分类',
        name: '分类名称',
        namePlaceholder: '例如：COCO 中转站',
        namePrefix: '账号名称前缀',
        namePrefixPlaceholder: '例如：COCO-cc-',
        baseUrl: '统一 URL',
        ...
        unassigned: '未分类账号',
        reorder: '调整分类顺序',
        finishReorder: '完成分类排序',
        dragProfile: '拖动调整分类顺序',
        dragAccount: '拖动调整账号位置',
        expandPlatforms: '展开平台分类',
        collapsePlatforms: '收起平台分类',
        resizeNavigation: '拖动调整分类目录宽度',
        orderSaved: '账号顺序已保存',
        orderSaveFailed: '账号顺序保存失败',
      ...
      syncAllUpstreamModels: '同步全部账号上游模型',
      syncAllUpstreamModelsLoading: '同步上游模型中...',
      syncAllUpstreamModelsDone: '上游模型同步完成：成功 {success} 个，失败 {failed} 个',
      syncAllUpstreamModelsFailed: '同步全部账号上游模型失败',
      syncUpstreamModelsReplaced: '上游模型列表已替换',
      batchApiKeyCreated: '成功创建 {count} 个账号',
      batchApiKeyFailed: '批量创建账号失败',
      batchApiKeyHint: '每行填写一个 API Key，可批量创建多个账号。',
      batchApiKeyPartial: '部分创建成功：成功 {success} 个，失败 {failed} 个',
      bulkEdit: {
        title: '批量编辑账号',
        ...
        accountOrder: '账号顺序',
        accountOrderDescription: '拖动账号设置调度优先级，提交时保存更改。',
        dragAccount: '拖动调整账号位置',
        noAccounts: '此分区暂无账号',
        orderSaveFailed: '账号顺序保存失败',
        orderSaved: '账号顺序已保存'
