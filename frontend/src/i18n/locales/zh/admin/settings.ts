    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          ...
          degradedThreshold: '响应降级阈值',
          secondsUnit: '秒',
          degradedThresholdHint: '仅 V1 主动探测使用：成功响应耗时达到此值（含边界）即标记为 degraded。默认 15 秒，范围 1 – 45 秒。',
        ...
        affiliate: {
          ...
          rebateRate: '实际返利比例',
          rebateRateHint: '真正参与后端返利结算的比例（0-100%，例如填写 10 表示实际返利 10%）。',
          displayRebateRate: '前端展示比例',
          displayRebateRateHint: '仅用于邀请页展示和推广文案，不参与后端返利结算。',
