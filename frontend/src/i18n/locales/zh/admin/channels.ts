export default {
    ...
    channelMonitor: {
      ...
      organization: {
        title: '监控分组与排序',
        description: '把渠道监控归入独立分组，并分别调整分组和组内监控的显示顺序。这里不使用业务分组。',
        createGroup: '新建监控分组',
        createdGroups: '已建分组',
        dragGroupHint: '拖动分组卡片调整显示顺序，松开后自动保存。',
        dragGroup: '拖动调整分组位置',
        editGroup: '编辑监控分组',
        groupName: '分组名称',
        groupNamePlaceholder: '例如：OpenAI 主线路',
        loading: '正在加载监控编排...',
        empty: '还没有渠道监控，请先新增监控。',
        noMonitors: '该分组暂时没有监控',
        monitors: '个监控',
        ungrouped: '未分组',
        ungroupedHint: '可以在每个监控面板右下角选择目标分组。',
        noModel: '未设置模型',
        unknownStatus: '未知状态',
        assignGroup: '选择监控分组',
        moveGroupUp: '分组上移',
        moveGroupDown: '分组下移',
        moveMonitorUp: '监控上移',
        moveMonitorDown: '监控下移',
        saved: '监控分组已保存',
        deleted: '监控分组已删除，监控已移至未分组',
        loadError: '加载监控分组失败',
        saveError: '保存监控分组失败',
        deleteConfirm: '确定删除监控分组「{name}」吗？其中的监控不会删除，只会移至未分组。',
        selectGroup: '选择该分组中的全部监控',
        selectMonitor: '选择监控「{name}」',
        bulkSelectedCount: '已选择 {count} 个监控',
        bulkEdit: '批量修改',
        clearSelection: '清空选择',
        selectAllMonitors: '全选监控',
        bulkEditTitle: '批量修改渠道监控',
        bulkEditHint: '只会修改勾选的参数，其余参数保持不变。',
        bulkEndpoint: '上游地址',
        bulkEndpointPlaceholder: '留空可清空地址（仅适用于配额模式）',
        bulkPrimaryModel: '主模型',
        bulkPrimaryModelPlaceholder: '例如：gpt-4o-mini',
        bulkInterval: '检测间隔（秒）',
        bulkJitter: '随机抖动（秒）',
        bulkEnabled: '启用状态',
        bulkSelectField: '请至少勾选一个要修改的参数',
        bulkIntervalInvalid: '检测间隔必须在 15 到 3600 秒之间',
        bulkJitterInvalid: '随机抖动不能使最小检测间隔低于 15 秒',
        bulkSubmit: '应用修改',
        bulkSaving: '正在批量修改...',
        bulkSuccess: '已成功修改 {count} 个监控',
        bulkPartial: '有 {failed} 个监控修改失败，请检查后重试'
      },
      form: {
        name: '名称',
        ...
        monitorGroup: '监控分组',
        monitorGroupPlaceholder: '选择监控分组',
        monitorGroupUngrouped: '未分组',
        monitorGroupHint: '独立于上面的业务分组名称，仅用于管理员监控页面的展示和排序。',
