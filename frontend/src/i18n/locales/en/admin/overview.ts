export default {
    ...
    dashboard: {
      ...
      notice: {
        ...
        create: 'Set dashboard notice',
        edit: 'Edit dashboard notice',
        contentLabel: 'Notice text',
      },
    },
    ...
    affiliates: {
      ...
      analytics: {
        ...
        rank: 'Rank', inviter: 'Inviter', periodInvites: 'Invites in range', periodRebateRows: 'Rebate entries', change: 'vs previous', totalInvites: 'Total invites (excl. today)', todayInvites: 'New today', periodRebateAmount: 'Rebate in range', lastInvite: 'Last invite', totalRebate: 'Lifetime rebate', empty: 'No data available',
    ...
    users: {
      ...
      freeBalance: 'Free trial credit',
      paidBalance: 'Paid balance (revenue-backed)',
      balanceSourceHint: 'Free credit is not revenue; paid balance usage is recognized as revenue.',
      balanceConfirmTitle: 'Confirm balance source',
      balanceConfirmMessage: 'Add {amount} as “{source}”? This choice will be used for profit reporting.',
    ...
    groups: {
      ...
      accounts: {
        ...
        expand: 'Expand accounts',
        collapse: 'Collapse accounts',
        add: 'Add account',
        addTitle: 'Add accounts to {name}',
        ...
        testCompleted: 'Completed tests for {count} account(s)',
        testSelectedGroups: 'Test selected groups ({count})',
        testingGroups: 'Testing groups...',
        testSelectedGroupsEmpty: 'No testable accounts in the selected groups',
        testGroupsCompleted: 'Completed tests for {count} account(s) in selected groups',
        enabledSelected: 'Enabled {count} account(s)',
        disabledSelected: 'Disabled {count} account(s)',
        updated: 'Accounts updated',
        removed: 'Account removed from group',
