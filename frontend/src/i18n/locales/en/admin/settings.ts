    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          ...
          degradedThreshold: 'Degraded response threshold',
          secondsUnit: 'seconds',
          degradedThresholdHint: 'V1 active probes only: a successful response at or above this latency is marked degraded. Default 15 seconds; range 1 – 45 seconds.',
        ...
        affiliate: {
          ...
          rebateRate: 'Actual rebate rate',
          rebateRateHint: 'Used by backend rebate settlement (0-100, e.g. 10 = 10%).',
          displayRebateRate: 'Frontend display rate',
          displayRebateRateHint: 'Used only in the invite page and promotional copy; never used for settlement.',
