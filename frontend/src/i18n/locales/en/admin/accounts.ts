export default {
    accounts: {
      ...
      upstreamProfiles: {
        fieldTooLong: 'Profile name or prefix exceeds 100 bytes, or URL exceeds 500 bytes.',
        duplicateId: 'Duplicate profile ID. Close and reopen the editor.',
        loading: 'Loading profiles…',
        loadFailed: 'Failed to load profiles. Retry; existing settings were not changed.',
        missingProfile: 'Missing profile #{id}',
        inUse: 'This profile still has accounts. Reassign them before removing it.',
        stale: 'Profiles changed in another window. Close and reopen the editor before saving.',
        title: 'Upstream Provider Profiles',
        description: 'Keep accounts from the same relay provider together with shared naming and URL standards.',
        manage: 'Manage Profiles',
        select: 'Upstream Provider Profile',
        none: 'No profile',
        name: 'Profile name',
        namePlaceholder: 'e.g. COCO relay',
        namePrefix: 'Account name prefix',
        namePrefixPlaceholder: 'e.g. COCO-cc-',
        baseUrl: 'Unified URL',
        baseUrlPlaceholder: 'e.g. https://api.example.com/v1',
        enabled: 'Available when adding accounts',
        add: 'Add profile',
        remove: 'Remove profile',
        empty: 'No upstream profiles yet.',
        noPrefix: 'No name prefix',
        noUrl: 'No URL',
        noAccounts: 'No accounts in this profile',
        allAccounts: 'All accounts',
        unassigned: 'Uncategorized accounts',
        reorder: 'Reorder profiles',
        finishReorder: 'Finish profile ordering',
        dragProfile: 'Drag to reorder profile',
        dragAccount: 'Drag to reorder account',
        expandPlatforms: 'Expand platform categories',
        collapsePlatforms: 'Collapse platform categories',
        resizeNavigation: 'Drag to resize the category navigation',
        orderSaved: 'Account order saved',
        orderSaveFailed: 'Failed to save account order',
        nameRequired: 'Enter a name for every profile.',
        saved: 'Upstream profiles saved.',
        saveFailed: 'Failed to save upstream profiles.'
      },
