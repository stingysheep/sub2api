export default {
    ...
    channelMonitor: {
      ...
      organization: {
        title: 'Monitor groups and order',
        description: 'Place monitors into independent groups and adjust group and in-group order. Business groups are not used here.',
        createGroup: 'New monitor group',
        createdGroups: 'Created groups',
        dragGroupHint: 'Drag a group card to change its display order. Changes save automatically.',
        dragGroup: 'Drag to reorder group',
        editGroup: 'Edit monitor group',
        groupName: 'Group name',
        groupNamePlaceholder: 'For example: OpenAI primary',
        loading: 'Loading monitor organization...',
        empty: 'No channel monitors yet. Create one first.',
        noMonitors: 'No monitors in this group',
        monitors: 'monitors',
        ungrouped: 'Ungrouped',
        ungroupedHint: 'Choose a destination group from the lower-right control on each monitor panel.',
        noModel: 'No model set',
        unknownStatus: 'Unknown status',
        assignGroup: 'Choose monitor group',
        moveGroupUp: 'Move group up',
        moveGroupDown: 'Move group down',
        moveMonitorUp: 'Move monitor up',
        moveMonitorDown: 'Move monitor down',
        saved: 'Monitor group saved',
        deleted: 'Monitor group deleted; monitors moved to ungrouped',
        loadError: 'Failed to load monitor groups',
        saveError: 'Failed to save monitor group',
        deleteConfirm: 'Delete monitor group "{name}"? Its monitors will be moved to ungrouped, not deleted.',
        selectGroup: 'Select all monitors in this group',
        selectMonitor: 'Select monitor "{name}"',
        bulkSelectedCount: '{count} monitor(s) selected',
        bulkEdit: 'Bulk edit',
        clearSelection: 'Clear selection',
        selectAllMonitors: 'Select all monitors',
        bulkEditTitle: 'Bulk edit channel monitors',
        bulkEditHint: 'Only checked fields will be changed; all other fields stay unchanged.',
        bulkEndpoint: 'Upstream endpoint',
        bulkEndpointPlaceholder: 'Leave empty to clear (quota mode only)',
        bulkPrimaryModel: 'Primary model',
        bulkPrimaryModelPlaceholder: 'For example: gpt-4o-mini',
        bulkInterval: 'Check interval (seconds)',
        bulkJitter: 'Random jitter (seconds)',
        bulkEnabled: 'Enabled state',
        bulkSelectField: 'Select at least one field to change',
        bulkIntervalInvalid: 'Check interval must be between 15 and 3600 seconds',
        bulkJitterInvalid: 'Jitter must keep the minimum interval at 15 seconds',
        bulkSubmit: 'Apply changes',
        bulkSaving: 'Applying bulk changes...',
        bulkSuccess: 'Successfully updated {count} monitor(s)',
        bulkPartial: '{failed} monitor(s) failed to update; check and retry'
      },
      form: {
        name: 'Name',
        ...
        monitorGroup: 'Monitor Group',
        monitorGroupPlaceholder: 'Choose a monitor group',
        monitorGroupUngrouped: 'Ungrouped',
        monitorGroupHint: 'Independent from the business group above; used only for admin monitor display and ordering.',
