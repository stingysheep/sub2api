export default {
  ...
  affiliate: {
    ...
    heroEyebrow: 'Share links · Earn continuously',
    heroTitle: 'Invite friends, keep earning',
    heroDescription: 'When friends register through your link and generate distributable profit, you earn rebate quota at the displayed rate.',
    heroCopyLink: 'Copy invite link',
    heroCopyCode: 'Copy invite code',
    viewDetails: 'View promotion earnings',
    copyLink: 'Copy invite link',
    copyCode: 'Copy invite code',
    rulesButton: 'Rebate rules',
    startTitle: 'Start promoting',
    startDescription: 'Copy your link or code and share it with friends and communities.',
    rulesTitle: 'Rebate rules',
    rulesFormulaTitle: 'How rebate is calculated',
    rulesFormula: 'Rebates come only from positive profit generated by invitees using paid balance. Free credit and loss-making requests earn no rebate.',
    rulesFormulaCode: 'Rebate = max(paid usage - matching upstream cost, 0) × actual rebate rate',
    rulesExampleTitle: 'Example calculation',
    rulesExample: 'Suppose an invitee generates $100 in paid usage and the matching upstream cost is $80. The distributable profit is $20; at a 25% rebate rate, the estimated rebate is $5.',
    rulesExampleIncome: 'Invitee paid usage',
    rulesExampleIncomeValue: '$100',
    rulesExampleCost: 'Matching upstream cost',
    rulesExampleCostValue: '$80',
    rulesNote: 'Free-credit usage, requests where upstream cost exceeds paid usage, and loss-making requests do not generate rebates.',
    steps: {
      shareTitle: 'Share the link', shareDescription: 'Send it to friends or communities',
      registerTitle: 'Friend registers', registerDescription: 'They complete registration through your link',
    ...
    stats: {
      ...
      rebateRateHint: 'Display rate only; actual rebate follows platform settlement rules',
    ...
    tips: {
      ...
      line2: 'When invitees generate distributable profit, the displayed rebate rate is {rate}.',
