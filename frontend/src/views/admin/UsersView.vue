<template>
  <AppLayout>
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-role="{ value }">
            <span :class="['badge', value === 'admin' ? 'badge-purple' : value === 'operator' ? 'badge-blue' : 'badge-gray']">
    ...
    <UserCreateModal v-if="showCreateModal" :show="showCreateModal" @close="showCreateModal = false" @success="loadUsers" />
...
const BulkEditUserModal = defineAsyncComponent(() => import('@/components/admin/user/BulkEditUserModal.vue'))
