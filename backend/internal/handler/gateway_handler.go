...
func (h *GatewayHandler) Messages(c *gin.Context) {
	...
	if platform == service.PlatformGemini {
		fs := NewFailoverState(maxAccountSwitchesForRequest(c, h.maxAccountSwitchesGemini), hasBoundSession)
	...
	for {
		fs := NewFailoverState(maxAccountSwitchesForRequest(c, h.maxAccountSwitches), hasBoundSession)
