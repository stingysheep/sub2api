...
func TestForwardAsRawChatCompletions_ForcesStreamUsageUpstreamAndPassesUsageDownstream(t *testing.T) {
	...
	require.ErrorIs(t, upstream.lastReq.Context().Err(), context.Canceled, "completed streams must release their request context")
...
func TestForwardAsRawChatCompletions_CanceledBeforeOutputDoesNotStartUpstream(t *testing.T) {
	setGinTestMode()
