		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"total_free_balance_cost": 0,
					"total_paid_balance_cost": 0,
					"total_unfunded_cost": 0,
					"total_free_upstream_cost": 0,
					"selected_free_upstream_cost": 0,
					"total_paid_upstream_cost": 0,
					"total_free_balance_issued": 0,
					"total_free_balance_consumed": 0,
